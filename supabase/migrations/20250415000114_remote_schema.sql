...
COMMENT ON TABLE "public"."waitlist_entries" IS 'Stores email addresses submitted for the waitlist.';



ALTER TABLE "public"."waitlist_entries" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."waitlist_entries_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
